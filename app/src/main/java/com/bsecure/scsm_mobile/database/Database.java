...
public class Database extends SQLiteOpenHelper {
    ...
    public final String CREATE_Students = "CREATE TABLE Students(student_id integer primary key,roll_no TEXT,student_name TEXT,parent_phone_number TEXT,class_id TEXT,status TEXT,extra_subjects TEXT,condition TEXT,examinations_id TEXT,marks_obtained TEXT,teacher_id TEXT,subject TEXT);";
