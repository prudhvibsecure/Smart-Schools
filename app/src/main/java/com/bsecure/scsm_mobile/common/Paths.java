...
public class Paths {
   ...
   // public static final String base = "https://bsecuresoftechsolutions.com/scs/prod/";
    ...
    public static final String sync_parent_message = base + "sync_data/sync_parent_message";
    ...
    public static final String view_photo_gallery_title = base + "photo_gallery/view_photo_gallery_title_v1";
