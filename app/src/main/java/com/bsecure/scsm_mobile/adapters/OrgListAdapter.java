...
import com.bsecure.scsm_mobile.modules.OrganizationModel;
...
public class OrgListAdapter extends RecyclerView.Adapter<OrgListAdapter.ContactViewHolder> {
    ...
    private List<OrganizationModel> classModelList;
    private SparseBooleanArray selectedItems;
    private SparseBooleanArray animationItemsIndex;
    private static int currentSelectedIndex = -1;
    private ItemTouchHelperExtension mItemTouchHelperExtension;

    public OrgListAdapter(List<OrganizationModel> list, Context context, ContactAdapterListener listener) {
...
//    }
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int position) {
        ...
        try {
            OrganizationModel teacher_lList = classModelList.get(position);
            contactViewHolder.tv_title.setText(teacher_lList.getName());
    ...
    private void applyEvents(ContactViewHolder contactViewHolder, final List<OrganizationModel> classModelList, final int position) {
    ...
    private void applyClickEvents(ContactViewHolder contactViewHolder, final List<OrganizationModel> classModelList, final int position) {
...
//            viewForeground = v.findViewById(R.id.view_foreground);
    ...
    public interface ContactAdapterListener {
        void onMessageRowClicked(List<OrganizationModel> matchesList, int position);

        void swipeToDelete(int position, List<OrganizationModel> classModelList);

        void swipeToStatus(int position, List<OrganizationModel> classModelList, String s);
    }
    ...
    class ItemSwipeWithActionWidthViewHolder extends ContactViewHolder implements Extension {
        ...
        public ItemSwipeWithActionWidthViewHolder(View itemView) {
            ...
            mActionViewDelete.setVisibility(View.GONE);
