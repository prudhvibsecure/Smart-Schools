...
public class IndividualStudentsAdapter extends RecyclerView.Adapter<IndividualStudentsAdapter.ContactViewHolder> {
    ...
    public IndividualStudentsAdapter(List<StudentModel> list, Context context, ContactAdapterListener listener) {
...
//    }
    ...
    @Override
    public void onBindViewHolder(final IndividualStudentsAdapter.ContactViewHolder contactViewHolder, final int position) {
...
//    }
    ...
    public class ContactViewHolder extends RecyclerView.ViewHolder {
        ...
        public ContactViewHolder(View v) {
            ...
            chk_name.setBackground(context.getDrawable(R.mipmap.ic_uncheck));
