...
public class SubjectListAdapter extends RecyclerView.Adapter<SubjectListAdapter.ContactViewHolder> {
    ...
    public SubjectListAdapter(List<Subjects> list, Context context, ContactAdapterListener listener) {
...
//    }
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int position) {
        ...
        try {
            ...
            int color = generator.getColor(classMode_lList.getSubject());
            TextDrawable ic1 = builder.build(classMode_lList.getSubject().substring(0, 2), color);
    ...
    private void applyClickEvents(ContactViewHolder contactViewHolder, final List<Subjects> classModelList, final int position) {
