...
public class TutorAssignStudentsListAdapter extends RecyclerView.Adapter<TutorAssignStudentsListAdapter.ContactViewHolder> {
    ...
    public TutorAssignStudentsListAdapter(List<StudentModel> list, Context context, ContactAdapterListener listener) {
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int position) {
        ...
        try {
            ...
            contactViewHolder.section_tv.setText(classMode_lList.getClass_name());
...
//            viewForeground = v.findViewById(R.id.view_foreground);
    ...
    public interface ContactAdapterListener {
       ...
       /* void swipeToMarks(int position, List<StudentModel> classModelList);*/
        ...
        void swipeToDelete(int position, List<StudentModel> classModelList);
    }
