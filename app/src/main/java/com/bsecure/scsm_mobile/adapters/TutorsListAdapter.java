...
public class TutorsListAdapter extends RecyclerView.Adapter<TutorsListAdapter.ContactViewHolder> {
    ...
    private List<TutorsModel> tutorsModelList;
    private SparseBooleanArray selectedItems;
    private SparseBooleanArray animationItemsIndex;
    private static int currentSelectedIndex = -1;

    public TutorsListAdapter(List<TutorsModel> list, Context context, ContactAdapterListener listener) {
...
//    }
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int position) {
        ...
        try {
            TutorsModel classMode_lList = tutorsModelList.get(position);
            contactViewHolder.tv_title.setText(classMode_lList.getTutor_name());
    ...
    private void applyClickEvents(ContactViewHolder contactViewHolder, final List<TutorsModel> classModelList, final int position) {
...
//            viewForeground = v.findViewById(R.id.view_foreground);
    ...
    public interface ContactAdapterListener {
        void onMessageRowClicked(List<TutorsModel> matchesList, int position);

        void swipeToEdit(int position, List<TutorsModel> classModelList);

        void swipeToDelete(int position, List<TutorsModel> classModelList);
    }
