...
public class StudentsListAdapter extends RecyclerView.Adapter<StudentsListAdapter.ContactViewHolder> {
    ...
    public StudentsListAdapter(List<StudentModel> list, Context context, ContactAdapterListener listener) {
