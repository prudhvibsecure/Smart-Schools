...
public class HTTPostJson extends AsyncTask<String, Long, Integer> {
    ...
    public HTTPostJson(HttpHandler callback, Context context, String postData, int requestId) {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            if (cacheType != 0) {
                ...
                obj = mCacheManager.getCache(context, requestUrl, cacheType);
                if (obj != null) {
            ...
            if (serverResponseCode == 200) {
                ...
                if (cacheType != 0) {
                    mCacheManager.setCache(context, requestUrl, cacheType, response);
                }
